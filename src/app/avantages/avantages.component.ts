...
export class AvantagesComponent {
  ...
  pageDescription: string =
    'Découvrez les 4 raisons de collaborer avec MSL Itech, votre partenaire certifié Odoo. Expertise, personnalisation, présence internationale, et coûts compétitifs.';
  pageKeywords: string =
    'MSL Itech, Odoo, partenaire Odoo, consulting Odoo, développement Odoo, intégration Odoo, ERP Odoo, Belgique, Canada, Maroc, personnalisation Odoo';
  ngOnInit(): void {
  ...
  private addStructuredData(): void {
    const structuredData = {
      ...
      description:
        'MSL Itech, partenaire certifié Odoo, offre des services de développement, intégration, et consulting ERP en Belgique, Canada, et Maroc.',
      offers: {
        '@type': 'Offer',
        priceCurrency: 'MAD',
